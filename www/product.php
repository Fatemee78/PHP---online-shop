...
<body>
  ...
  <div class="container">
    <div class="row">
        <form action="<?php $_SERVER['PHP_SELF'];?>" method="post" enctype="multipart/form-data" name="ad-post" id="ad-post" >
            ...
            <div class="col-md-2 col-sm-4">
                ...
                <option>Fatemeh </option>
                <option>Zahra </option>
                </select>
            </div>
            <div class="col-md-2 col-sm-3">
                <input type="submit" class="btn" name="submit" value="Search Ad">
            </div>
        </form>
    </div>
  </div>
